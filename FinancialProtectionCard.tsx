...
export const FinancialProtectionCard = ({ financials, userAge, onUpdate, isOpen, onToggle, isCompleted, potentialPoints }: { financials: Financials; userAge: number | undefined; onUpdate: (data: Insurance) => void; isOpen: boolean; onToggle: (e: React.MouseEvent<HTMLButtonElement>) => void; isCompleted: boolean; potentialPoints: number; }) => {
